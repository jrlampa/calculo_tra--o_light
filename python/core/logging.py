...
class StructuredFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        extra_fields = {
            ...
            if key not in _LOG_RECORD_RESERVED_FIELDS
...
def configure_specific_loggers(log_level: int):
    ...
    external_loggers = ["urllib3.connectionpool", "requests", "boto3", "botocore"]
...
def log_security_event(event_type: str, details: str, ip: Optional[str] = None, **kwargs):
    ...
    logger.warning(
        ...
        extra={
            "security_event": {"event_type": event_type, "details": details, "ip": ip, **kwargs}
        },
    )
...
def log_business_event(event_type: str, details: Dict[str, Any], **kwargs):
    ...
    logger.info(
        ...
        extra={"business_event": {"event_type": event_type, "details": details, **kwargs}},
    )
...
def log_database_query(query: str, duration: float, table: Optional[str] = None, **kwargs):
    ...
    logger.debug(
        ...
        extra={"database_query": {"query": query, "duration": duration, "table": table, **kwargs}},
    )
...
def log_cache_operation(operation: str, key: str, hit: bool, **kwargs):
    ...
    logger.debug(
        ...
        extra={"cache_operation": {"operation": operation, "key": key, "hit": hit, **kwargs}},
    )
